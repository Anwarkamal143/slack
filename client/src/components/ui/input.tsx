    ...
    return (
      <input
        ...
        className={cn(
          ...
          "flex h-10 w-full rounded-md border border-input bg-background px-2 py-2 text-sm  file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-inputActive   disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
        {...props}
